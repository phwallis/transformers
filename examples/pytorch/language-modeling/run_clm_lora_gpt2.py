...
class ModelArguments:
    ...
    adapter_type: str = field(
        default='qv',
        metadata={
            "help": "adapter type specifies what part of the network architecture will adapter (q, v or qv which is the "
            " default)."
        },
    )
    adapter_dim: int = field(
        default=16,
        metadata={
            "help": "Specify the adapter dim (dimentionality of the adapter projection)."
        },
    )
    adapter_alpha: int = field(
        default=32,
        metadata={
            "help": "Specify the adapter alpha value (used for scaling)."
        },
    )
